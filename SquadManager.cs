...
<p>Do you think this plug-in useful and you want to buy me a beer?</p>
...
<b>Allow Team Switches:</b> Players can invitee other players even if they are in the enemy team.<br> 
...
<h2><p>Changelog</p></h2>  
<blockquote><h4>0.9.7.4 (09-Jan-2015)</h4><br>  
...
public List<CPluginVariable> GetDisplayPluginVariables()
{
    ...
    lstReturn.Add(new CPluginVariable("8 - Messages|Send messages how to use this plugin", WriteMessages.GetType(), WriteMessages));
    lstReturn.Add(new CPluginVariable("8 - Messages|Interval (seconds)", Interval.GetType(), Interval));

    lstReturn.Add(new CPluginVariable("9 - SquadManager|Debug level", fDebugLevel.GetType(), fDebugLevel));
